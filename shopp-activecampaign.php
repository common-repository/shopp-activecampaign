<?php
/*
Plugin Name: Shopp + ActiveCampaign
Description: Customers who opt-in to email marketing from your WordPress ecommerce site during checkout are added to a specified list on ActiveCampaign.
Version: 1.3
...
Shopp_ActiveCampaign::smartLoad();

class Shopp_ActiveCampaign {
	public static $APIURL;
	public static $APIKey;
	public static $ListID;

	public static function smartLoad() {
		$instantiate = apply_filters('shoppActiveCampaignLoadBasic', true);
		if ($instantiate) { new Shopp_ActiveCampaign; }
	}
	
	public function __construct() {
		add_action('admin_init', array($this, 'admin_css'));
		add_action('admin_menu', array($this, 'admin_menu'));
		add_action('shopp_order_success', array($this, 'add_to_activecampaign_list'));
        
        $this->APIURL = get_option('shopp_activecampaign_APIURL');
		$this->APIKey = get_option('shopp_activecampaign_APIKey');
		$this->ListID = get_option('shopp_activecampaign_ListID');
	}

	public function admin_css() {
		wp_register_style( 'shopp-activecampaign-stylesheet', plugins_url( 'css/shopp-activecampaign.css', __FILE__ ), array(), '20140823' );
		wp_enqueue_style( 'shopp-activecampaign-stylesheet' );
	}
    ...
    public function admin_menu() {
		...
		$page = add_submenu_page('shopp-101-extensions', 'ActiveCampaign', 'ActiveCampaign', 'shopp_menu', 'shopp-activecampaign', array($this, 'render_display_settings'));
	        add_action( 'admin_print_styles-' . $page, 'admin_styles' );
	}
	...
	<div class="postbox-container" style="width:65%;">
		<div class="metabox-holder">	
			...
			<div id="shopp-extensions-support-feedback" class="postbox">
				...
				<p>Our plugins are <strong>actively supported</strong>. Support is provided as a courtesy by Lorenzo Orlando Caum, Enzo12 LLC. If you have any questions or concerns, please open a <a href="http://shopp101.com/help/" title="Open a new support ticket with Optimize My Shopp">new support ticket</a> via our help desk.</p>
			...
			<div id="shopp-extensions-about-the-author" class="postbox">
				...
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
                            <td width="70%"><div><img style="padding: 0px 15px 0px 0px; float:left" src="<?php echo plugins_url( 'shopp-activecampaign/images/lorenzo-orlando-caum-shopp-wordpress-150x150.jpg' , dirname(__FILE__) ); ?>" border="0" alt="Founder of Enzo12 LLC" width="150" height="150">
...
<?php	 	 
	...
	public function add_to_activecampaign_list($Purchase) {
		global $wpdb;
	...
	public function render_display_settings() {
		wp_nonce_field('shopp-activecampaign');	
		if(!empty($_POST['submit'])){
            $this->APIURL = stripslashes($_POST['APIURL']);
			$this->APIKey = stripslashes($_POST['APIKey']);
			$this->ListID = stripslashes($_POST['ListID']);
			
            update_option("shopp_activecampaign_APIURL", $this->APIURL);
			update_option("shopp_activecampaign_APIKey", $this->APIKey);
			update_option("shopp_activecampaign_ListID", $this->ListID);
		}
?>

<div class="wrap">
	<h2>Shopp + ActiveCampaign</h2>
	<div class="postbox-container" style="width:65%;">
		<div class="metabox-holder">	

			<div id="shopp-activecampaign-introduction" class="postbox">
				<h3 class="hndle"><span>Introduction</span></h3>
				<div class="inside">
					<p>This plugin integrates <a href="http://shopp101.com/go/shopp/" title="Learn more about Shopp">Shopp</a> with <a href="http://shopp101.com/go/activecampaign/" title="Learn more about ActiveCampaign">ActiveCampaign</a> and is part of the Shopp 101 extensions.</p> 
					<p>During checkout, a customer has the option to opt-in to email marketing. If they choose to do so, then they will be added to a specified email list on ActiveCampaign.</p>
					...
					<p>Credit to ActiveCampaign who created the PHP API Wrapper for the ActiveCampaign API. <a href="https://github.com/ActiveCampaign/activecampaign-api-php" title="Learn about the PHP API Wrapper for ActiveCampaign">Learn more about the ActiveCampaign API</a></p>
				</div>
			</div>

			<div id="shopp-activecampaign-general-settings" class="postbox">
				<h3 class="hndle"><span>Setup Tutorial</span></h3>
				<div class="inside">
				<p><strong>How to Find Your Information from ActiveCampaign</strong><br /><br /><iframe src="http://player.vimeo.com/video/53945491?title=0&amp;byline=0&amp;portrait=0" width="600" height="300" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></p>
                <p>Pro-tip: After starting a video, click on the fullscreen button which appears to the right of the HD toggle.</p>
				</div>
			</div>
			
			<div id="shopp-activecampaign-support-feedback" class="postbox">
				<h3 class="hndle"><span>Support & Feedback</span></h3>
				<div class="inside">
				...
				<p>You can share feedback via this a <a href="http://shopp101.com/go/shopp-extensions-survey/" title="Take a super short survey">short survey</a>. Takes just a few minutes &mdash; we promise!</p>
				<p>Feeling generous? You can support the continued development of the Shopp + ActiveCampaign by <a href="http://shopp101.com/go/donate-shopp-activecampaign/" title="Say thank you by purchasing Lorenzo a Redbull">buying me a Redbull</a>, <a href="http://shopp101.com/go/amazonwishlist/" title="Say thank you by gifting Lorenzo a book">ordering me a book</a> from my Amazon wishlist, or <a href="http://shopp101.com/go/tip-shopp-help-desk/" title="Say thank you by tipping Lorenzo via the Shopp Help Desk">tipping me</a> through the Shopp help desk.</p>
				</div>
			</div>
			
			<div id="shopp-activecampaign-settings" class="postbox">
				<h3 class="hndle"><span>ActiveCampaign Settings</span></h3>
				<div class="inside">
					<p>
                    ...
                    <tr>
                        <th>API URL:</th>
                        <td><input type="text" name="APIURL"  size="35" value="<?php echo $this->APIURL; ?>" /></td>
                    </tr>
                    <tr>
						<th>API Key:</th>
			...
			<div id="shopp-activecampaign-about-the-author" class="postbox">
				<h3 class="hndle"><span>About the Author</span></h3>
				<div class="inside">
					<table border="0" width="100%">
   					 	<tr>
	...
	<div class="postbox-container" style="width:25%;">
		<div class="metabox-holder">	
			...
			<div id="shopp-activecampaign-donate" class="postbox">
				<h3 class="hndle"><span><strong>Make a Donation!</strong></span></h3>
				<div class="inside">
					<p>Hi friend!</p>
					<p>If this plugin is helpful to you, then please <a href="http://shopp101.com/go/donate-shopp-activecampaign/" title="Say thank you by purchasing Lorenzo a Redbull">buy me a Redbull</a>.</p>
					...
					<p>Your kindness is appreciated and will go towards <em>continued development</em> of the Shopp + ActiveCampaign plugin.</p>
				</div>
			</div>
			
			<div id="shopp-activecampaign-subscribe" class="postbox">
			...
			<div id="shopp-activecampaign-have-a-question" class="postbox">
				<h3 class="hndle"><span>Have a Question?</span></h3>
				<div class="inside">
					<p>Open a <a href="http://shopp101.com/help/" title="Open a new support ticket with Shopp 101">new support ticket</a> for Shopp + ActiveCampaign</p>
			...
			<div id="shopp-activecampaign-news-from-oms" class="postbox">
				<h3 class="hndle"><span>News from Shopp 101</span></h3>
				<div class="inside"><p>Free Report<br /> <a href="http://shopp101.com/newsletter/" title="Receive your free report delivered instantly to your inbox">10 Steps to a More Secure WordPress</a></p>
				<p>Documents & Presentations<br /> <a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on creating a fast Shopp website">Speeding up your Shopp Ecommerce Website</a><br /><a href="http://shopp101.com/resources/white-papers/" title="Get your free white paper on using Shopp with caching plugins">Shopp + Caching Plugins</a></p>
				<?php _e('Recent posts from the blog'); ?>
				<?php
				include_once(ABSPATH . WPINC . '/feed.php');
			...
			<div id="shopp-activecampaign-recommendations" class="postbox">
